...
my.iris<- readJPEG(readBin(iris.img, "raw", 1e6))
# my.iris <- readJPEG(getURLContent(iris.img)) 
# getURLContent() - HTTPS appears in the URL when a website is secured by an 
# SSL (security sockets Layer) /TLS (Transport Layer Security) certificate. 
# If SSL/TLS is outdated, calling that function will produce error.
